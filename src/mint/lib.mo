...
import Ver1 "../mint/memory/v1";
import I "../mint/interface";
...
module {
    ...
    public class Mod({
        ...
        public type MintNodeMem = Ver1.MintNodeMem;
        ...
        public func meta() : T.Meta {
            {
                ...
                name = "Mint TCYCLES";
                author = "jes1";
                description = "Mints TCYCLES from ICP";
                supported_ledgers = [#ic(Principal.fromText("ryjl3-tyaaa-aaaaa-aaaba-cai"))]; // Internet Computer ledger
                version = #beta([0, 1, 0]);
                create_allowed = true;
                ledger_slots = [
                    "TCYCLES"
        ...
        module Run {
            public func single(vid : T.NodeId, vec : T.NodeCoreMem, nodeMem : MintNodeMem) : () {};

            public func singleAsync(vid : T.NodeId, vec : T.NodeCoreMem, nodeMem : MintNodeMem) : async* () {};
        };

        public func create(vid : T.NodeId, _req : T.CommonCreateRequest, t : I.CreateRequest) : T.Create {
            let nodeMem : MintNodeMem = {
                variables = {};
            };
